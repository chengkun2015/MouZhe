...
public class WaterWaveAttrInit {
	...
	public WaterWaveAttrInit(Context context, AttributeSet attrs, int defStyle) {
		...
		progressColor = typedArray.getColor(
				R.styleable.WaterWaveProgress_progressColor, 0xFF01FDA7);
		progressBgColor = typedArray.getColor(
				R.styleable.WaterWaveProgress_progressBgColor, 0xEEEEEEEF);
		waterWaveColor = typedArray.getColor(
				R.styleable.WaterWaveProgress_waterWaveColor, 0XEE4AB5E8);
		waterWaveBgColor = typedArray.getColor(
				R.styleable.WaterWaveProgress_waterWaveBgColor, 0x000000);
